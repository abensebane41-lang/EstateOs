      ...
      <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-border bg-white p-6">
            ...
            <div className="mb-6 flex flex-wrap gap-6 border-b border-border pb-6">
              ...
              {property.listingType && (
                <Badge variant="outline">{property.listingType === "SALE" ? "للبيع" : "للإيجار"}</Badge>
              )}
            </div>
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-border bg-white p-6 sticky top-24">
            <h3 className="mb-4 text-lg font-semibold text-text-primary">معلومات التواصل</h3>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-secondary">الوكالة العقارية</p>
                </div>
              </div>
            ...
            <div className="border-t border-border pt-6">
              <h4 className="mb-4 text-sm font-semibold text-text-primary">أرسل رسالة مباشرة</h4>
              <ContactForm

        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            ...
            <p className="mt-4 text-white/60 text-sm">
              {stats._count} {t("propertiesAvailable")}
            </p>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {properties.length === 0 ? (
          <div className="py-20 text-center">
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-2">{t("noPropertiesFound")}</h3>
            <p className="text-text-secondary mb-8 max-w-md mx-auto">{t("tryExpandSearch")}</p>

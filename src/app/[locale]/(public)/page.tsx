        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {(
              ...
              >
                <div
                  className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${bg} transition-colors`}
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {(
              ...
              >
                <div
                  className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-white/5`}
                >

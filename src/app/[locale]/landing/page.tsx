      ...
      <nav className="sticky top-0 z-50 border-b border-white/8 bg-[#0B0F1A]/80 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="rounded-lg bg-accent px-5 py-2 text-sm font-bold text-[#0B0F1A] hover:bg-accent-light transition-colors"
            >
              ابدأ مجاناً
            </Link>
          </div>
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {(["1", "2", "3"] as const).map((n, i) => (
              <div key={n} className="relative text-center">
                ...
                <p className="mx-auto max-w-xs text-sm text-white/40">{t(`step${n}Desc`)}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03]">
            <div className="grid grid-cols-3 border-b border-white/10 bg-white/[0.04]">
              <div className="px-5 py-4 text-sm font-medium text-white/50">{t("comparisonFeature")}</div>
              <div className="border-x border-white/10 px-5 py-4 text-center text-sm font-bold text-accent">EstateOS</div>
              <div className="px-5 py-4 text-center text-sm font-medium text-white/40">المنافسون</div>
            </div>
            ...
            {(
              ...
              <div key={feature} className={`grid grid-cols-3 ${i < 6 ? "border-b border-white/5" : ""}`}>
                <div className="flex items-center px-5 py-3.5 text-sm text-white/60">{t(feature)}</div>

            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                >
                  ...
                  <p className="text-xs text-text-tertiary">{t("uploadFormats")}</p>
                </div>
                <input
                  ref={fileInputRef}
                  type="file"
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <Button type="submit" disabled={loading || uploadingImages} className="flex-1">
                {uploadingImages ? t("uploading") : loading ? t("saving") : t("createProperty")}
              </Button>
              <Button
                type="button"
                variant="outline"

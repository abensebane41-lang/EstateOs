  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div>
        ...
        <p className="text-sm text-text-secondary">مرحباً بك في لوحة تحكم المدير العام</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex items-center gap-4 rounded-xl border border-border bg-white p-4">
          ...
          <div>
            <p className="text-sm text-text-secondary">الوكالات</p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-xl border border-border bg-white p-6 lg:col-span-2">
          <h2 className="mb-4 text-lg font-semibold text-text-primary">آخر الوكالات</h2>
          <div className="space-y-3">
            {recentAgencies.length === 0 ? (
              <p className="py-8 text-center text-sm text-text-secondary">لا توجد وكالات بعد</p>
            ) : (
